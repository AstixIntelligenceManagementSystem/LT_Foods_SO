...
DBAdapterLtFoods dbengine=new DBAdapterLtFoods(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BugSenseHandler.setup(this, "1b736635");
   ...
   public String BitMapToString(Bitmap bitmap)
   {
    ...
    public void callBroadCast() {
        if (Build.VERSION.SDK_INT >= 14) {
            Log.e("-->", " >= 14");
            MediaScannerConnection.scanFile(Splash_Activity.this, new String[]{Environment.getExternalStorageDirectory().toString()}, null, new MediaScannerConnection.OnScanCompletedListener() {
            ...
            Log.e("-->", " < 14");
            Splash_Activity.this.sendBroadcast(new Intent(Intent.ACTION_MEDIA_MOUNTED,
    ...
    public void onCreateFunctionality()
    {
       ...
       // imei="357278088220588"; // Live User

      // imei="353572080913610";  // Dev

      // imei="867290026163310";  // Test Release
        ...
        if(isOnline())
        {
          ...
          /*  CheckUpdateVersion cuv= new CheckUpdateVersion();
            cuv.execute();*/
            //if date same dont get data else get data for second webservice
            ...
            if (chkFlgForErrorToCloseApp == 1)   // if Webservice showing exception or not excute complete properly
            {
              ...
              //  Toast.makeText(getApplicationContext(), "Internet connection is slow ,please try again.", Toast.LENGTH_LONG).show();
                ...
                if (checkUserAuthenticate == 0)   // 0 means-->New user        1 means-->Exist User
                {
                   ...
                   // Toast.makeText(getApplicationContext(), "This phone is not registered, please contact administrator", Toast.LENGTH_LONG).show();
                    return;
